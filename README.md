...
Figure 14. A formatted title added to the map
...
* As we saw in the first lesson, to launch a local web server using Atom, select **Packages -> Live Server -> Start** or use the keyboard shortcut.
